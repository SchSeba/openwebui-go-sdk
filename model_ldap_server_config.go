...
type LdapServerConfig struct {
	...
	AttributeForMail *string `json:"attribute_for_mail,omitempty"`
...
func NewLdapServerConfig(label string, host string, appDn string, appDnPassword string, searchBase string) *LdapServerConfig {
	...
	this.Label = label
	this.Host = host
	var attributeForMail string = "mail"
	this.AttributeForMail = &attributeForMail
...
// GetAttributeForMail returns the AttributeForMail field value if set, zero value otherwise.
func (o *LdapServerConfig) GetAttributeForMail() string {
	if o == nil || IsNil(o.AttributeForMail) {
		var ret string
		return ret
	}
	return *o.AttributeForMail
}

// GetAttributeForMailOk returns a tuple with the AttributeForMail field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *LdapServerConfig) GetAttributeForMailOk() (*string, bool) {
	if o == nil || IsNil(o.AttributeForMail) {
		return nil, false
	}
	return o.AttributeForMail, true
}
...
// SetAttributeForMail gets a reference to the given string and assigns it to the AttributeForMail field.
func (o *LdapServerConfig) SetAttributeForMail(v string) {
	o.AttributeForMail = &v
}
...
func (o LdapServerConfig) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.AttributeForMail) {
		toSerialize["attribute_for_mail"] = o.AttributeForMail
	}
