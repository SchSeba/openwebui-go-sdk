...
type ApiReindexKnowledgeFilesApiV1KnowledgeReindexPostRequest struct {
	ctx context.Context
	ApiService *KnowledgeAPIService
}

func (r ApiReindexKnowledgeFilesApiV1KnowledgeReindexPostRequest) Execute() (bool, *http.Response, error) {
	return r.ApiService.ReindexKnowledgeFilesApiV1KnowledgeReindexPostExecute(r)
}

/*
ReindexKnowledgeFilesApiV1KnowledgeReindexPost Reindex Knowledge Files

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return ApiReindexKnowledgeFilesApiV1KnowledgeReindexPostRequest
*/
func (a *KnowledgeAPIService) ReindexKnowledgeFilesApiV1KnowledgeReindexPost(ctx context.Context) ApiReindexKnowledgeFilesApiV1KnowledgeReindexPostRequest {
	return ApiReindexKnowledgeFilesApiV1KnowledgeReindexPostRequest{
		ApiService: a,
		ctx: ctx,
	}
...
// Execute executes the request
//  @return bool
func (a *KnowledgeAPIService) ReindexKnowledgeFilesApiV1KnowledgeReindexPostExecute(r ApiReindexKnowledgeFilesApiV1KnowledgeReindexPostRequest) (bool, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "KnowledgeAPIService.ReindexKnowledgeFilesApiV1KnowledgeReindexPost")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/api/v1/knowledge/reindex"
