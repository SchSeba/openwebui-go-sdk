...
type ApiLoadToolFromUrlApiV1ToolsLoadUrlPostRequest struct {
	ctx context.Context
	ApiService *ToolsAPIService
	loadUrlForm *LoadUrlForm
}

func (r ApiLoadToolFromUrlApiV1ToolsLoadUrlPostRequest) LoadUrlForm(loadUrlForm LoadUrlForm) ApiLoadToolFromUrlApiV1ToolsLoadUrlPostRequest {
	r.loadUrlForm = &loadUrlForm
	return r
}

func (r ApiLoadToolFromUrlApiV1ToolsLoadUrlPostRequest) Execute() (map[string]interface{}, *http.Response, error) {
	return r.ApiService.LoadToolFromUrlApiV1ToolsLoadUrlPostExecute(r)
}

/*
LoadToolFromUrlApiV1ToolsLoadUrlPost Load Tool From Url

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return ApiLoadToolFromUrlApiV1ToolsLoadUrlPostRequest
*/
func (a *ToolsAPIService) LoadToolFromUrlApiV1ToolsLoadUrlPost(ctx context.Context) ApiLoadToolFromUrlApiV1ToolsLoadUrlPostRequest {
	return ApiLoadToolFromUrlApiV1ToolsLoadUrlPostRequest{
		ApiService: a,
		ctx: ctx,
	}
...
// Execute executes the request
//  @return map[string]interface{}
func (a *ToolsAPIService) LoadToolFromUrlApiV1ToolsLoadUrlPostExecute(r ApiLoadToolFromUrlApiV1ToolsLoadUrlPostRequest) (map[string]interface{}, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "ToolsAPIService.LoadToolFromUrlApiV1ToolsLoadUrlPost")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/api/v1/tools/load/url"
...
func (r ApiUpdateToolsUserValvesByIdApiV1ToolsIdIdValvesUserUpdatePostRequest) RequestBody(requestBody map[string]interface{}) ApiUpdateToolsUserValvesByIdApiV1ToolsIdIdValvesUserUpdatePostRequest {
...
func (r ApiUpdateToolsValvesByIdApiV1ToolsIdIdValvesUpdatePostRequest) RequestBody(requestBody map[string]interface{}) ApiUpdateToolsValvesByIdApiV1ToolsIdIdValvesUpdatePostRequest {
	r.requestBody = &requestBody
	return r
}
