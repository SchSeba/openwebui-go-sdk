...
type ApiGetAllChannelsApiV1ChannelsListGetRequest struct {
	ctx context.Context
	ApiService *ChannelsAPIService
}

func (r ApiGetAllChannelsApiV1ChannelsListGetRequest) Execute() ([]ChannelModel, *http.Response, error) {
	return r.ApiService.GetAllChannelsApiV1ChannelsListGetExecute(r)
}

/*
GetAllChannelsApiV1ChannelsListGet Get All Channels

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return ApiGetAllChannelsApiV1ChannelsListGetRequest
*/
func (a *ChannelsAPIService) GetAllChannelsApiV1ChannelsListGet(ctx context.Context) ApiGetAllChannelsApiV1ChannelsListGetRequest {
	return ApiGetAllChannelsApiV1ChannelsListGetRequest{
		ApiService: a,
		ctx: ctx,
	}
...
// Execute executes the request
//  @return []ChannelModel
func (a *ChannelsAPIService) GetAllChannelsApiV1ChannelsListGetExecute(r ApiGetAllChannelsApiV1ChannelsListGetRequest) ([]ChannelModel, *http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "ChannelsAPIService.GetAllChannelsApiV1ChannelsListGet")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/api/v1/channels/list"
...
func (r ApiPostNewMessageApiV1ChannelsIdMessagesPostPostRequest) OpenWebuiModelsMessagesMessageForm(openWebuiModelsMessagesMessageForm OpenWebuiModelsMessagesMessageForm) ApiPostNewMessageApiV1ChannelsIdMessagesPostPostRequest {
	r.openWebuiModelsMessagesMessageForm = &openWebuiModelsMessagesMessageForm
	return r
}
...
func (a *ChannelsAPIService) PostNewMessageApiV1ChannelsIdMessagesPostPostExecute(r ApiPostNewMessageApiV1ChannelsIdMessagesPostPostRequest) (*MessageModel, *http.Response, error) {
	...
	localVarQueryParams := url.Values{}
	localVarFormParams := url.Values{}
	if r.openWebuiModelsMessagesMessageForm == nil {
		return localVarReturnValue, nil, reportError("openWebuiModelsMessagesMessageForm is required and must be specified")
	}
	...
	// body params
	localVarPostBody = r.openWebuiModelsMessagesMessageForm
	req, err := a.client.prepareRequest(r.ctx, localVarPath, localVarHTTPMethod, localVarPostBody, localVarHeaderParams, localVarQueryParams, localVarFormParams, formFiles)
	if err != nil {
		return localVarReturnValue, nil, err
	}
...
func (r ApiUpdateMessageByIdApiV1ChannelsIdMessagesMessageIdUpdatePostRequest) OpenWebuiModelsMessagesMessageForm(openWebuiModelsMessagesMessageForm OpenWebuiModelsMessagesMessageForm) ApiUpdateMessageByIdApiV1ChannelsIdMessagesMessageIdUpdatePostRequest {
	r.openWebuiModelsMessagesMessageForm = &openWebuiModelsMessagesMessageForm
	return r
}
