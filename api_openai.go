...
func (r ApiGenerateChatCompletionOpenaiChatCompletionsPostRequest) RequestBody(requestBody map[string]interface{}) ApiGenerateChatCompletionOpenaiChatCompletionsPostRequest {
...
type ApiProxyOpenaiPathDeleteRequest struct {
	ctx context.Context
	ApiService *OpenaiAPIService
	path string
}

func (r ApiProxyOpenaiPathDeleteRequest) Execute() (interface{}, *http.Response, error) {
	return r.ApiService.ProxyOpenaiPathDeleteExecute(r)
}

/*
ProxyOpenaiPathDelete Proxy

Deprecated: proxy all requests to OpenAI API

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param path
 @return ApiProxyOpenaiPathDeleteRequest
*/
func (a *OpenaiAPIService) ProxyOpenaiPathDelete(ctx context.Context, path string) ApiProxyOpenaiPathDeleteRequest {
	return ApiProxyOpenaiPathDeleteRequest{
		ApiService: a,
		ctx: ctx,
		path: path,
...
// Execute executes the request
//  @return interface{}
func (a *OpenaiAPIService) ProxyOpenaiPathDeleteExecute(r ApiProxyOpenaiPathDeleteRequest) (interface{}, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "OpenaiAPIService.ProxyOpenaiPathDelete")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
...
type ApiProxyOpenaiPathDelete_0Request struct {
	ctx context.Context
	ApiService *OpenaiAPIService
	path string
}

func (r ApiProxyOpenaiPathDelete_0Request) Execute() (interface{}, *http.Response, error) {
	return r.ApiService.ProxyOpenaiPathDelete_1Execute(r)
}

/*
ProxyOpenaiPathDelete_0 Proxy

Deprecated: proxy all requests to OpenAI API

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param path
 @return ApiProxyOpenaiPathDelete_0Request
*/
func (a *OpenaiAPIService) ProxyOpenaiPathDelete_1(ctx context.Context, path string) ApiProxyOpenaiPathDelete_0Request {
	return ApiProxyOpenaiPathDelete_0Request{
		ApiService: a,
		ctx: ctx,
		path: path,
...
// Execute executes the request
//  @return interface{}
func (a *OpenaiAPIService) ProxyOpenaiPathDelete_1Execute(r ApiProxyOpenaiPathDelete_0Request) (interface{}, *http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "OpenaiAPIService.ProxyOpenaiPathDelete_1")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
...
type ApiProxyOpenaiPathDelete_1Request struct {
	ctx context.Context
	ApiService *OpenaiAPIService
	path string
}

func (r ApiProxyOpenaiPathDelete_1Request) Execute() (interface{}, *http.Response, error) {
	return r.ApiService.ProxyOpenaiPathDelete_2Execute(r)
}

/*
ProxyOpenaiPathDelete_1 Proxy

Deprecated: proxy all requests to OpenAI API

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param path
 @return ApiProxyOpenaiPathDelete_1Request
*/
func (a *OpenaiAPIService) ProxyOpenaiPathDelete_2(ctx context.Context, path string) ApiProxyOpenaiPathDelete_1Request {
	return ApiProxyOpenaiPathDelete_1Request{
		ApiService: a,
		ctx: ctx,
		path: path,
...
// Execute executes the request
//  @return interface{}
func (a *OpenaiAPIService) ProxyOpenaiPathDelete_2Execute(r ApiProxyOpenaiPathDelete_1Request) (interface{}, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "OpenaiAPIService.ProxyOpenaiPathDelete_2")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
...
type ApiProxyOpenaiPathDelete_2Request struct {
	ctx context.Context
	ApiService *OpenaiAPIService
	path string
}

func (r ApiProxyOpenaiPathDelete_2Request) Execute() (interface{}, *http.Response, error) {
	return r.ApiService.ProxyOpenaiPathDelete_3Execute(r)
}

/*
ProxyOpenaiPathDelete_2 Proxy

Deprecated: proxy all requests to OpenAI API

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param path
 @return ApiProxyOpenaiPathDelete_2Request
*/
func (a *OpenaiAPIService) ProxyOpenaiPathDelete_3(ctx context.Context, path string) ApiProxyOpenaiPathDelete_2Request {
	return ApiProxyOpenaiPathDelete_2Request{
		ApiService: a,
		ctx: ctx,
		path: path,
...
// Execute executes the request
//  @return interface{}
func (a *OpenaiAPIService) ProxyOpenaiPathDelete_3Execute(r ApiProxyOpenaiPathDelete_2Request) (interface{}, *http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "OpenaiAPIService.ProxyOpenaiPathDelete_3")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
