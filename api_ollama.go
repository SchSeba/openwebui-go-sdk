...
func (r ApiGenerateChatCompletionOllamaApiChatPostRequest) RequestBody(requestBody map[string]interface{}) ApiGenerateChatCompletionOllamaApiChatPostRequest {
...
func (r ApiGenerateChatCompletionOllamaApiChatUrlIdxPostRequest) RequestBody(requestBody map[string]interface{}) ApiGenerateChatCompletionOllamaApiChatUrlIdxPostRequest {
	r.requestBody = &requestBody
	return r
}
...
func (r ApiGenerateOpenaiChatCompletionOllamaV1ChatCompletionsPostRequest) RequestBody(requestBody map[string]interface{}) ApiGenerateOpenaiChatCompletionOllamaV1ChatCompletionsPostRequest {
	r.requestBody = &requestBody
	return r
}
...
func (r ApiGenerateOpenaiChatCompletionOllamaV1ChatCompletionsUrlIdxPostRequest) RequestBody(requestBody map[string]interface{}) ApiGenerateOpenaiChatCompletionOllamaV1ChatCompletionsUrlIdxPostRequest {
	r.requestBody = &requestBody
	return r
}
...
func (r ApiGenerateOpenaiCompletionOllamaV1CompletionsPostRequest) RequestBody(requestBody map[string]interface{}) ApiGenerateOpenaiCompletionOllamaV1CompletionsPostRequest {
	r.requestBody = &requestBody
	return r
}
...
func (r ApiGenerateOpenaiCompletionOllamaV1CompletionsUrlIdxPostRequest) RequestBody(requestBody map[string]interface{}) ApiGenerateOpenaiCompletionOllamaV1CompletionsUrlIdxPostRequest {
	r.requestBody = &requestBody
	return r
}
...
type ApiUnloadModelOllamaApiUnloadPostRequest struct {
	ctx context.Context
	ApiService *OllamaAPIService
	modelNameForm *ModelNameForm
}

func (r ApiUnloadModelOllamaApiUnloadPostRequest) ModelNameForm(modelNameForm ModelNameForm) ApiUnloadModelOllamaApiUnloadPostRequest {
	r.modelNameForm = &modelNameForm
	return r
}

func (r ApiUnloadModelOllamaApiUnloadPostRequest) Execute() (interface{}, *http.Response, error) {
	return r.ApiService.UnloadModelOllamaApiUnloadPostExecute(r)
}

/*
UnloadModelOllamaApiUnloadPost Unload Model

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return ApiUnloadModelOllamaApiUnloadPostRequest
*/
func (a *OllamaAPIService) UnloadModelOllamaApiUnloadPost(ctx context.Context) ApiUnloadModelOllamaApiUnloadPostRequest {
	return ApiUnloadModelOllamaApiUnloadPostRequest{
		ApiService: a,
		ctx: ctx,
	}
...
// Execute executes the request
//  @return interface{}
func (a *OllamaAPIService) UnloadModelOllamaApiUnloadPostExecute(r ApiUnloadModelOllamaApiUnloadPostRequest) (interface{}, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "OllamaAPIService.UnloadModelOllamaApiUnloadPost")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/ollama/api/unload"
