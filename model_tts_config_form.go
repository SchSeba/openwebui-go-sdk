...
type TTSConfigForm struct {
	...
	AZURE_SPEECH_BASE_URL string `json:"AZURE_SPEECH_BASE_URL"`
...
func NewTTSConfigForm(oPENAIAPIBASEURL string, oPENAIAPIKEY string, aPIKEY string, eNGINE string, mODEL string, vOICE string, sPLITON string, aZURESPEECHREGION string, aZURESPEECHBASEURL string, aZURESPEECHOUTPUTFORMAT string) *TTSConfigForm {
	...
	this.AZURE_SPEECH_BASE_URL = aZURESPEECHBASEURL
...
// GetAZURE_SPEECH_BASE_URL returns the AZURE_SPEECH_BASE_URL field value
func (o *TTSConfigForm) GetAZURE_SPEECH_BASE_URL() string {
	...
	return o.AZURE_SPEECH_BASE_URL
}

// GetAZURE_SPEECH_BASE_URLOk returns a tuple with the AZURE_SPEECH_BASE_URL field value
// and a boolean to check if the value has been set.
func (o *TTSConfigForm) GetAZURE_SPEECH_BASE_URLOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
	return &o.AZURE_SPEECH_BASE_URL, true
}

// SetAZURE_SPEECH_BASE_URL sets field value
func (o *TTSConfigForm) SetAZURE_SPEECH_BASE_URL(v string) {
	o.AZURE_SPEECH_BASE_URL = v
}
...
func (o TTSConfigForm) ToMap() (map[string]interface{}, error) {
	...
	toSerialize["AZURE_SPEECH_BASE_URL"] = o.AZURE_SPEECH_BASE_URL
