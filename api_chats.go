...
func (r ApiGetArchivedSessionUserChatListApiV1ChatsArchivedGetRequest) Page(page int32) ApiGetArchivedSessionUserChatListApiV1ChatsArchivedGetRequest {
	r.page = &page
	return r
}

func (r ApiGetArchivedSessionUserChatListApiV1ChatsArchivedGetRequest) Query(query string) ApiGetArchivedSessionUserChatListApiV1ChatsArchivedGetRequest {
	r.query = &query
	return r
}

func (r ApiGetArchivedSessionUserChatListApiV1ChatsArchivedGetRequest) OrderBy(orderBy string) ApiGetArchivedSessionUserChatListApiV1ChatsArchivedGetRequest {
	r.orderBy = &orderBy
	return r
}

func (r ApiGetArchivedSessionUserChatListApiV1ChatsArchivedGetRequest) Direction(direction string) ApiGetArchivedSessionUserChatListApiV1ChatsArchivedGetRequest {
...
func (r ApiGetUserChatListByUserIdApiV1ChatsListUserUserIdGetRequest) Page(page int32) ApiGetUserChatListByUserIdApiV1ChatsListUserUserIdGetRequest {
	r.page = &page
	return r
}

func (r ApiGetUserChatListByUserIdApiV1ChatsListUserUserIdGetRequest) Query(query string) ApiGetUserChatListByUserIdApiV1ChatsListUserUserIdGetRequest {
	r.query = &query
	return r
}

func (r ApiGetUserChatListByUserIdApiV1ChatsListUserUserIdGetRequest) OrderBy(orderBy string) ApiGetUserChatListByUserIdApiV1ChatsListUserUserIdGetRequest {
	r.orderBy = &orderBy
	return r
}

func (r ApiGetUserChatListByUserIdApiV1ChatsListUserUserIdGetRequest) Direction(direction string) ApiGetUserChatListByUserIdApiV1ChatsListUserUserIdGetRequest {
	r.direction = &direction
	return r
}
...
func (r ApiGetUserPinnedChatsApiV1ChatsPinnedGetRequest) Execute() ([]ChatTitleIdResponse, *http.Response, error) {
...
// Execute executes the request
//  @return []ChatTitleIdResponse
func (a *ChatsAPIService) GetUserPinnedChatsApiV1ChatsPinnedGetExecute(r ApiGetUserPinnedChatsApiV1ChatsPinnedGetRequest) ([]ChatTitleIdResponse, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
type ApiSendChatMessageEventByIdApiV1ChatsIdMessagesMessageIdEventPostRequest struct {
	ctx context.Context
	ApiService *ChatsAPIService
	id string
	messageId string
...
func (r ApiSendChatMessageEventByIdApiV1ChatsIdMessagesMessageIdEventPostRequest) EventForm(eventForm EventForm) ApiSendChatMessageEventByIdApiV1ChatsIdMessagesMessageIdEventPostRequest {
	r.eventForm = &eventForm
	return r
}

func (r ApiSendChatMessageEventByIdApiV1ChatsIdMessagesMessageIdEventPostRequest) Execute() (bool, *http.Response, error) {
	return r.ApiService.SendChatMessageEventByIdApiV1ChatsIdMessagesMessageIdEventPostExecute(r)
}

/*
SendChatMessageEventByIdApiV1ChatsIdMessagesMessageIdEventPost Send Chat Message Event By Id

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param id
 @param messageId
 @return ApiSendChatMessageEventByIdApiV1ChatsIdMessagesMessageIdEventPostRequest
*/
func (a *ChatsAPIService) SendChatMessageEventByIdApiV1ChatsIdMessagesMessageIdEventPost(ctx context.Context, id string, messageId string) ApiSendChatMessageEventByIdApiV1ChatsIdMessagesMessageIdEventPostRequest {
	return ApiSendChatMessageEventByIdApiV1ChatsIdMessagesMessageIdEventPostRequest{
		ApiService: a,
		ctx: ctx,
		id: id,
...
// Execute executes the request
//  @return bool
func (a *ChatsAPIService) SendChatMessageEventByIdApiV1ChatsIdMessagesMessageIdEventPostExecute(r ApiSendChatMessageEventByIdApiV1ChatsIdMessagesMessageIdEventPostRequest) (bool, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "ChatsAPIService.SendChatMessageEventByIdApiV1ChatsIdMessagesMessageIdEventPost")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/api/v1/chats/{id}/messages/{message_id}/event"
	localVarPath = strings.Replace(localVarPath, "{"+"id"+"}", url.PathEscape(parameterValueToString(r.id, "id")), -1)
	...
	localVarFormParams := url.Values{}
	if r.eventForm == nil {
		return localVarReturnValue, nil, reportError("eventForm is required and must be specified")
	}
...
type ApiUpdateChatMessageByIdApiV1ChatsIdMessagesMessageIdPostRequest struct {
	ctx context.Context
	ApiService *ChatsAPIService
	id string
	messageId string
...
func (r ApiUpdateChatMessageByIdApiV1ChatsIdMessagesMessageIdPostRequest) OpenWebuiRoutersChatsMessageForm(openWebuiRoutersChatsMessageForm OpenWebuiRoutersChatsMessageForm) ApiUpdateChatMessageByIdApiV1ChatsIdMessagesMessageIdPostRequest {
	r.openWebuiRoutersChatsMessageForm = &openWebuiRoutersChatsMessageForm
	return r
}

func (r ApiUpdateChatMessageByIdApiV1ChatsIdMessagesMessageIdPostRequest) Execute() (*ChatResponse, *http.Response, error) {
	return r.ApiService.UpdateChatMessageByIdApiV1ChatsIdMessagesMessageIdPostExecute(r)
}

/*
UpdateChatMessageByIdApiV1ChatsIdMessagesMessageIdPost Update Chat Message By Id

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param id
 @param messageId
 @return ApiUpdateChatMessageByIdApiV1ChatsIdMessagesMessageIdPostRequest
*/
func (a *ChatsAPIService) UpdateChatMessageByIdApiV1ChatsIdMessagesMessageIdPost(ctx context.Context, id string, messageId string) ApiUpdateChatMessageByIdApiV1ChatsIdMessagesMessageIdPostRequest {
	return ApiUpdateChatMessageByIdApiV1ChatsIdMessagesMessageIdPostRequest{
		ApiService: a,
		ctx: ctx,
		id: id,
...
// Execute executes the request
//  @return ChatResponse
func (a *ChatsAPIService) UpdateChatMessageByIdApiV1ChatsIdMessagesMessageIdPostExecute(r ApiUpdateChatMessageByIdApiV1ChatsIdMessagesMessageIdPostRequest) (*ChatResponse, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "ChatsAPIService.UpdateChatMessageByIdApiV1ChatsIdMessagesMessageIdPost")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/api/v1/chats/{id}/messages/{message_id}"
	localVarPath = strings.Replace(localVarPath, "{"+"id"+"}", url.PathEscape(parameterValueToString(r.id, "id")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"message_id"+"}", url.PathEscape(parameterValueToString(r.messageId, "messageId")), -1)
	...
	localVarQueryParams := url.Values{}
	localVarFormParams := url.Values{}
	if r.openWebuiRoutersChatsMessageForm == nil {
		return localVarReturnValue, nil, reportError("openWebuiRoutersChatsMessageForm is required and must be specified")
	}
	...
	// body params
	localVarPostBody = r.openWebuiRoutersChatsMessageForm
	req, err := a.client.prepareRequest(r.ctx, localVarPath, localVarHTTPMethod, localVarPostBody, localVarHeaderParams, localVarQueryParams, localVarFormParams, formFiles)
	if err != nil {
		return localVarReturnValue, nil, err
	}
