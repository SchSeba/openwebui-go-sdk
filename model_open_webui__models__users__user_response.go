...
// checks if the OpenWebuiModelsUsersUserResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &OpenWebuiModelsUsersUserResponse{}

// OpenWebuiModelsUsersUserResponse struct for OpenWebuiModelsUsersUserResponse
type OpenWebuiModelsUsersUserResponse struct {
	Id string `json:"id"`
...
type _OpenWebuiModelsUsersUserResponse OpenWebuiModelsUsersUserResponse
...
func NewOpenWebuiModelsUsersUserResponse(id string, email string, name string, role string, profileImageUrl string) *OpenWebuiModelsUsersUserResponse {
	this := OpenWebuiModelsUsersUserResponse{}
	this.Id = id
	this.Email = email
	this.Name = name
	this.Role = role
...
func (o OpenWebuiModelsUsersUserResponse) MarshalJSON() ([]byte, error) {
...
func (o OpenWebuiModelsUsersUserResponse) ToMap() (map[string]interface{}, error) {
...
func (o *OpenWebuiModelsUsersUserResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varOpenWebuiModelsUsersUserResponse := _OpenWebuiModelsUsersUserResponse{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varOpenWebuiModelsUsersUserResponse)

	if err != nil {
		return err
	}

	*o = OpenWebuiModelsUsersUserResponse(varOpenWebuiModelsUsersUserResponse)

	return err
}

type NullableOpenWebuiModelsUsersUserResponse struct {
	value *OpenWebuiModelsUsersUserResponse
	isSet bool
}

func (v NullableOpenWebuiModelsUsersUserResponse) Get() *OpenWebuiModelsUsersUserResponse {
	return v.value
}

func (v *NullableOpenWebuiModelsUsersUserResponse) Set(val *OpenWebuiModelsUsersUserResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableOpenWebuiModelsUsersUserResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableOpenWebuiModelsUsersUserResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableOpenWebuiModelsUsersUserResponse(val *OpenWebuiModelsUsersUserResponse) *NullableOpenWebuiModelsUsersUserResponse {
	return &NullableOpenWebuiModelsUsersUserResponse{value: val, isSet: true}
}

func (v NullableOpenWebuiModelsUsersUserResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableOpenWebuiModelsUsersUserResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
