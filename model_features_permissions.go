...
type FeaturesPermissions struct {
	DirectToolServers *bool `json:"direct_tool_servers,omitempty"`
...
func NewFeaturesPermissions() *FeaturesPermissions {
	...
	var directToolServers bool = false
	this.DirectToolServers = &directToolServers
...
// GetDirectToolServers returns the DirectToolServers field value if set, zero value otherwise.
func (o *FeaturesPermissions) GetDirectToolServers() bool {
	if o == nil || IsNil(o.DirectToolServers) {
		var ret bool
		return ret
	}
	return *o.DirectToolServers
}

// GetDirectToolServersOk returns a tuple with the DirectToolServers field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *FeaturesPermissions) GetDirectToolServersOk() (*bool, bool) {
	if o == nil || IsNil(o.DirectToolServers) {
		return nil, false
	}
	return o.DirectToolServers, true
}
...
// SetDirectToolServers gets a reference to the given bool and assigns it to the DirectToolServers field.
func (o *FeaturesPermissions) SetDirectToolServers(v bool) {
	o.DirectToolServers = &v
}
...
func (o FeaturesPermissions) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.DirectToolServers) {
		toSerialize["direct_tool_servers"] = o.DirectToolServers
	}
