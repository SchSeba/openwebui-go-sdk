...
func Test_openapi_OllamaAPIService(t *testing.T) {
	...
	t.Run("Test OllamaAPIService UnloadModelOllamaApiUnloadPost", func(t *testing.T) {

		t.Skip("skip test") // remove to run test

		resp, httpRes, err := apiClient.OllamaAPI.UnloadModelOllamaApiUnloadPost(context.Background()).Execute()
