...
func Test_openapi_ToolsAPIService(t *testing.T) {
	...
	t.Run("Test ToolsAPIService LoadToolFromUrlApiV1ToolsLoadUrlPost", func(t *testing.T) {

		t.Skip("skip test") // remove to run test

		resp, httpRes, err := apiClient.ToolsAPI.LoadToolFromUrlApiV1ToolsLoadUrlPost(context.Background()).Execute()
