...
func Test_openapi_FunctionsAPIService(t *testing.T) {
	...
	t.Run("Test FunctionsAPIService LoadFunctionFromUrlApiV1FunctionsLoadUrlPost", func(t *testing.T) {

		t.Skip("skip test") // remove to run test

		resp, httpRes, err := apiClient.FunctionsAPI.LoadFunctionFromUrlApiV1FunctionsLoadUrlPost(context.Background()).Execute()
	...
	t.Run("Test FunctionsAPIService SyncFunctionsApiV1FunctionsSyncPost", func(t *testing.T) {

		t.Skip("skip test") // remove to run test

		resp, httpRes, err := apiClient.FunctionsAPI.SyncFunctionsApiV1FunctionsSyncPost(context.Background()).Execute()
