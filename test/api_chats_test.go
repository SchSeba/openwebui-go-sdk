...
func Test_openapi_ChatsAPIService(t *testing.T) {
	...
	t.Run("Test ChatsAPIService SendChatMessageEventByIdApiV1ChatsIdMessagesMessageIdEventPost", func(t *testing.T) {
		...
		resp, httpRes, err := apiClient.ChatsAPI.SendChatMessageEventByIdApiV1ChatsIdMessagesMessageIdEventPost(context.Background(), id, messageId).Execute()
	...
	t.Run("Test ChatsAPIService UpdateChatMessageByIdApiV1ChatsIdMessagesMessageIdPost", func(t *testing.T) {
		...
		resp, httpRes, err := apiClient.ChatsAPI.UpdateChatMessageByIdApiV1ChatsIdMessagesMessageIdPost(context.Background(), id, messageId).Execute()
