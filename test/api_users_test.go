...
func Test_openapi_UsersAPIService(t *testing.T) {
	...
	t.Run("Test UsersAPIService GetActiveUsersApiV1UsersActiveGet", func(t *testing.T) {

		t.Skip("skip test") // remove to run test

		resp, httpRes, err := apiClient.UsersAPI.GetActiveUsersApiV1UsersActiveGet(context.Background()).Execute()
	...
	t.Run("Test UsersAPIService GetAllUsersApiV1UsersAllGet", func(t *testing.T) {

		t.Skip("skip test") // remove to run test

		resp, httpRes, err := apiClient.UsersAPI.GetAllUsersApiV1UsersAllGet(context.Background()).Execute()
	...
	t.Run("Test UsersAPIService GetDefaultUserPermissionsApiV1UsersDefaultPermissionsGet", func(t *testing.T) {

		t.Skip("skip test") // remove to run test

		resp, httpRes, err := apiClient.UsersAPI.GetDefaultUserPermissionsApiV1UsersDefaultPermissionsGet(context.Background()).Execute()
	...
	t.Run("Test UsersAPIService GetUserActiveStatusByIdApiV1UsersUserIdActiveGet", func(t *testing.T) {

		t.Skip("skip test") // remove to run test

		var userId string

		resp, httpRes, err := apiClient.UsersAPI.GetUserActiveStatusByIdApiV1UsersUserIdActiveGet(context.Background(), userId).Execute()
	...
	t.Run("Test UsersAPIService UpdateDefaultUserPermissionsApiV1UsersDefaultPermissionsPost", func(t *testing.T) {

		t.Skip("skip test") // remove to run test

		resp, httpRes, err := apiClient.UsersAPI.UpdateDefaultUserPermissionsApiV1UsersDefaultPermissionsPost(context.Background()).Execute()
