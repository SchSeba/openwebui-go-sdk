...
func Test_openapi_KnowledgeAPIService(t *testing.T) {
	...
	t.Run("Test KnowledgeAPIService ReindexKnowledgeFilesApiV1KnowledgeReindexPost", func(t *testing.T) {

		t.Skip("skip test") // remove to run test

		resp, httpRes, err := apiClient.KnowledgeAPI.ReindexKnowledgeFilesApiV1KnowledgeReindexPost(context.Background()).Execute()
