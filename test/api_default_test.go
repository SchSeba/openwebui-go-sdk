...
func Test_openapi_DefaultAPIService(t *testing.T) {
	...
	t.Run("Test DefaultAPIService EmbeddingsApiEmbeddingsPost", func(t *testing.T) {

		t.Skip("skip test") // remove to run test

		resp, httpRes, err := apiClient.DefaultAPI.EmbeddingsApiEmbeddingsPost(context.Background()).Execute()
	...
	t.Run("Test DefaultAPIService GetCurrentUsageApiUsageGet", func(t *testing.T) {

		t.Skip("skip test") // remove to run test

		resp, httpRes, err := apiClient.DefaultAPI.GetCurrentUsageApiUsageGet(context.Background()).Execute()
	...
	t.Run("Test DefaultAPIService ListTasksByChatIdEndpointApiTasksChatChatIdGet", func(t *testing.T) {

		t.Skip("skip test") // remove to run test

		var chatId string

		resp, httpRes, err := apiClient.DefaultAPI.ListTasksByChatIdEndpointApiTasksChatChatIdGet(context.Background(), chatId).Execute()
	...
	t.Run("Test DefaultAPIService ServeCacheFileCachePathGet", func(t *testing.T) {

		t.Skip("skip test") // remove to run test

		var path string

		resp, httpRes, err := apiClient.DefaultAPI.ServeCacheFileCachePathGet(context.Background(), path).Execute()
