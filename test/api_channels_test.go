...
func Test_openapi_ChannelsAPIService(t *testing.T) {
	...
	t.Run("Test ChannelsAPIService GetAllChannelsApiV1ChannelsListGet", func(t *testing.T) {

		t.Skip("skip test") // remove to run test

		resp, httpRes, err := apiClient.ChannelsAPI.GetAllChannelsApiV1ChannelsListGet(context.Background()).Execute()
