...
func Test_openapi_FilesAPIService(t *testing.T) {
	...
	t.Run("Test FilesAPIService SearchFilesApiV1FilesSearchGet", func(t *testing.T) {

		t.Skip("skip test") // remove to run test

		resp, httpRes, err := apiClient.FilesAPI.SearchFilesApiV1FilesSearchGet(context.Background()).Execute()
