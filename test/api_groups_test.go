...
func Test_openapi_GroupsAPIService(t *testing.T) {
	...
	t.Run("Test GroupsAPIService AddUserToGroupApiV1GroupsIdIdUsersAddPost", func(t *testing.T) {

		t.Skip("skip test") // remove to run test

		var id string

		resp, httpRes, err := apiClient.GroupsAPI.AddUserToGroupApiV1GroupsIdIdUsersAddPost(context.Background(), id).Execute()
	...
	t.Run("Test GroupsAPIService RemoveUsersFromGroupApiV1GroupsIdIdUsersRemovePost", func(t *testing.T) {

		t.Skip("skip test") // remove to run test

		var id string

		resp, httpRes, err := apiClient.GroupsAPI.RemoveUsersFromGroupApiV1GroupsIdIdUsersRemovePost(context.Background(), id).Execute()
