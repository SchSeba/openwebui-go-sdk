...
type ApiLoadFunctionFromUrlApiV1FunctionsLoadUrlPostRequest struct {
	ctx context.Context
	ApiService *FunctionsAPIService
	loadUrlForm *LoadUrlForm
}

func (r ApiLoadFunctionFromUrlApiV1FunctionsLoadUrlPostRequest) LoadUrlForm(loadUrlForm LoadUrlForm) ApiLoadFunctionFromUrlApiV1FunctionsLoadUrlPostRequest {
	r.loadUrlForm = &loadUrlForm
	return r
}

func (r ApiLoadFunctionFromUrlApiV1FunctionsLoadUrlPostRequest) Execute() (map[string]interface{}, *http.Response, error) {
	return r.ApiService.LoadFunctionFromUrlApiV1FunctionsLoadUrlPostExecute(r)
}

/*
LoadFunctionFromUrlApiV1FunctionsLoadUrlPost Load Function From Url

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return ApiLoadFunctionFromUrlApiV1FunctionsLoadUrlPostRequest
*/
func (a *FunctionsAPIService) LoadFunctionFromUrlApiV1FunctionsLoadUrlPost(ctx context.Context) ApiLoadFunctionFromUrlApiV1FunctionsLoadUrlPostRequest {
	return ApiLoadFunctionFromUrlApiV1FunctionsLoadUrlPostRequest{
		ApiService: a,
		ctx: ctx,
	}
...
// Execute executes the request
//  @return map[string]interface{}
func (a *FunctionsAPIService) LoadFunctionFromUrlApiV1FunctionsLoadUrlPostExecute(r ApiLoadFunctionFromUrlApiV1FunctionsLoadUrlPostRequest) (map[string]interface{}, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "FunctionsAPIService.LoadFunctionFromUrlApiV1FunctionsLoadUrlPost")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/api/v1/functions/load/url"

	localVarHeaderParams := make(map[string]string)
	localVarQueryParams := url.Values{}
	localVarFormParams := url.Values{}
	if r.loadUrlForm == nil {
		return localVarReturnValue, nil, reportError("loadUrlForm is required and must be specified")
	}
	...
	// body params
	localVarPostBody = r.loadUrlForm
	req, err := a.client.prepareRequest(r.ctx, localVarPath, localVarHTTPMethod, localVarPostBody, localVarHeaderParams, localVarQueryParams, localVarFormParams, formFiles)
	if err != nil {
		return localVarReturnValue, nil, err
	}
...
type ApiSyncFunctionsApiV1FunctionsSyncPostRequest struct {
	ctx context.Context
	ApiService *FunctionsAPIService
	syncFunctionsForm *SyncFunctionsForm
}

func (r ApiSyncFunctionsApiV1FunctionsSyncPostRequest) SyncFunctionsForm(syncFunctionsForm SyncFunctionsForm) ApiSyncFunctionsApiV1FunctionsSyncPostRequest {
	r.syncFunctionsForm = &syncFunctionsForm
	return r
}

func (r ApiSyncFunctionsApiV1FunctionsSyncPostRequest) Execute() (*FunctionModel, *http.Response, error) {
	return r.ApiService.SyncFunctionsApiV1FunctionsSyncPostExecute(r)
}

/*
SyncFunctionsApiV1FunctionsSyncPost Sync Functions

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return ApiSyncFunctionsApiV1FunctionsSyncPostRequest
*/
func (a *FunctionsAPIService) SyncFunctionsApiV1FunctionsSyncPost(ctx context.Context) ApiSyncFunctionsApiV1FunctionsSyncPostRequest {
	return ApiSyncFunctionsApiV1FunctionsSyncPostRequest{
		ApiService: a,
		ctx: ctx,
	}
...
// Execute executes the request
//  @return FunctionModel
func (a *FunctionsAPIService) SyncFunctionsApiV1FunctionsSyncPostExecute(r ApiSyncFunctionsApiV1FunctionsSyncPostRequest) (*FunctionModel, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "FunctionsAPIService.SyncFunctionsApiV1FunctionsSyncPost")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/api/v1/functions/sync"

	localVarHeaderParams := make(map[string]string)
	localVarQueryParams := url.Values{}
	localVarFormParams := url.Values{}
	if r.syncFunctionsForm == nil {
		return localVarReturnValue, nil, reportError("syncFunctionsForm is required and must be specified")
	}
	...
	// body params
	localVarPostBody = r.syncFunctionsForm
	req, err := a.client.prepareRequest(r.ctx, localVarPath, localVarHTTPMethod, localVarPostBody, localVarHeaderParams, localVarQueryParams, localVarFormParams, formFiles)
	if err != nil {
		return localVarReturnValue, nil, err
	}
...
func (r ApiUpdateFunctionUserValvesByIdApiV1FunctionsIdIdValvesUserUpdatePostRequest) RequestBody(requestBody map[string]interface{}) ApiUpdateFunctionUserValvesByIdApiV1FunctionsIdIdValvesUserUpdatePostRequest {
...
func (r ApiUpdateFunctionValvesByIdApiV1FunctionsIdIdValvesUpdatePostRequest) RequestBody(requestBody map[string]interface{}) ApiUpdateFunctionValvesByIdApiV1FunctionsIdIdValvesUpdatePostRequest {
	r.requestBody = &requestBody
	return r
}
