...
type FeedbackUserResponse struct {
	...
	User NullableOpenWebuiRoutersEvaluationsUserResponse `json:"user,omitempty"`
}
...
func (o *FeedbackUserResponse) GetUser() OpenWebuiRoutersEvaluationsUserResponse {
	if o == nil || IsNil(o.User.Get()) {
		var ret OpenWebuiRoutersEvaluationsUserResponse
		return ret
	}
	return *o.User.Get()
}
...
// SetUser gets a reference to the given NullableOpenWebuiRoutersEvaluationsUserResponse and assigns it to the User field.
